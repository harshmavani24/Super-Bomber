...
banner() {
    ...
    toilet -f ivrit 'White-Devil' | boxes -d cat -a hc -p h8 | lolcat
    else
    cowsay 'White-Devil' | lolcat
    fi
    echo 'This Bomber Was Created By White-Devil' | lolcat
    echo 'For Any Queries Contact Me!!!'| lolcat
    echo 'Intagram:- White-Devil'| lolcat
    echo ' '| lolcat
...
do
	...
	echo -e "\e[4;34m This Bomber Was Created By White-Devil \e[0m" | lolcat
	echo -e "\e[1;34m For Any Queries Contact Me!!!\e[0m"| lolcat
	echo -e "\e[1;32m   Intagram:- White-Devil\e[0m"| lolcat
	echo -e "\e[4;32m   Whatsapp: +16473603582\e[0m"| lolcat
        exit
    elif [ $ch -eq 0 ];then
        banner
        exit
